...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(35, 203, 167));
        ...
        jButton2.setFont(new java.awt.Font("MS UI Gothic", 2, 18)); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/extra/access-3550527_1280 (1).png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ravlog","Varun","Varun@2998");
            Statement st=con.createStatement();
            String q="Select * from logintest;";
            ...
            if(rs.next())
            {
                ...
                if(a.equals(Userid) && Password.equals(c) && b.equals(Username))
                {
